...
export const load: PageServerLoad = async ({ locals }) => {
	...
	return {
		...
		minFulfillmentProfitNgn: pricing.minFulfillmentProfitNgn,
		maxPriceMultiple: pricing.maxPriceMultiple,
		otpReplacementWaitSeconds: pricing.otpReplacementWaitSeconds,
		pvapinsRateLimitPerMin: pricing.pvapinsRateLimitPerMin,
