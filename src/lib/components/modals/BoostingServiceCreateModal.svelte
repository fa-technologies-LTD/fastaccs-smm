					...
					<div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
						<div class="mb-4">
							<h3 class="flex items-center gap-2 text-lg font-semibold" style="color: var(--text);">
								...
								Add Boosting Service
							</h3>
							<p class="mt-1 text-sm" style="color: var(--text-muted);">
								Customers will see this on the Boosting Services page and submit their own link.
							</p>
						</div>
						...
						<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
							...
							<div class="md:col-span-2">
								...
								<textarea
									...
									class="mt-1 block w-full rounded-md px-4 py-2"
									style="border: 1px solid var(--border); background: var(--bg); color: var(--text);"
									placeholder="Shown to customers on the Boosting Services page"
								></textarea>
							</div>
